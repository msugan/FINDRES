...
def correlate_waves(trace1, trace2, max_shift, **kwargs):
    ...
    if trace1.stats.npts >= trace2.stats.npts:
        data1, data2, is_swapped = trace1.data, trace2.data, False
    else:
        data1, data2, is_swapped = trace2.data, trace1.data, True
...
def find_slope(cross_spectrum, frequency_range, params):
    ...
    coherence_threshold = params['cs_coherence_threshold']
    ...
    indices = longest_subsequence_of_trues((coherence > coherence_threshold) &
